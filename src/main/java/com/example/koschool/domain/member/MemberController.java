...
public class MemberController {
    ...
    public ApiResponse<MemberResponseDto> loginMember(@RequestBody LoginMemberRequestDto loginMemberRequestDto, HttpSession httpSession) {
        MemberResponseDto memberResponseDto = memberService.loginMember(loginMemberRequestDto.getId());
        httpSession.setAttribute("memberId", loginMemberRequestDto.getId());
